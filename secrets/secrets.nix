let
  ...
  gtrun-nixos-root = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIAMXsVZL2R82IvgXq9PLKJRbV6hVoBwlIwxNAWSzCruM root@nixos";
  #ssh-keygen -o -a 256 -t ed25519 -C "$(hostname)-$('USER)-$(date +'%d-%m-%Y')"
  #######################
  # Users Authorization #
  #######################
  owner = [ gtrun-nixos gtrun-macos gtrun-nixos-root ];
in
{
