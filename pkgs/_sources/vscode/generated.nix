...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  vscode-extensions-copilot = {
    ...
    version = "1.57.7193";
    src = fetchurl {
      url = "https://GitHub.gallery.vsassets.io/_apis/public/gallery/publisher/GitHub/extension/copilot/1.57.7193/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "copilot-1.57.7193.zip";
      sha256 = "sha256-DdR5RqkJWlJvAhY7Rs51GDo+blBAMYmzGaoplHn3vso=";
    };
    license = "mit";
    homepage = "none";
    description = "none";
  ...
  vscode-extensions-language-julia = {
    ...
    version = "1.38.2";
    src = fetchurl {
      url = "https://julialang.gallery.vsassets.io/_apis/public/gallery/publisher/julialang/extension/language-julia/1.38.2/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
  ...
  vscode-extensions-rust-analyzer = {
    ...
    version = "0.4.1274";
    src = fetchurl {
      url = "https://rust-lang.gallery.vsassets.io/_apis/public/gallery/publisher/rust-lang/extension/rust-analyzer/0.4.1274/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "rust-analyzer-0.4.1274.zip";
      sha256 = "sha256-U+FKFX+3IuaOCyFafzI+kqW0ueKouCn4VX+mB01x5dk=";
    };
    license = "mit";
    homepage = "none";
    description = "none";
  ...
  vscode-extensions-vscode-direnv = {
    ...
    version = "0.7.0";
    src = fetchurl {
      url = "https://mkhl.gallery.vsassets.io/_apis/public/gallery/publisher/mkhl/extension/direnv/0.7.0/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "direnv-0.7.0.zip";
