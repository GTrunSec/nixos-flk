...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  StevenBlack-hosts = {
    ...
    version = "ae38b087f3947c69649b3fe9f203042c861555b1";
    src = fetchFromGitHub ({
      owner = "StevenBlack";
      repo = "hosts";
      rev = "ae38b087f3947c69649b3fe9f203042c861555b1";
      fetchSubmodules = false;
      sha256 = "sha256-CwKWJ0YEUc5+9JkkR0KVL+WVoSFk93ACJAYxG/CUh5s=";
    });
  };
  adguardhome = {
    pname = "adguardhome";
  ...
  promnesia = {
    pname = "promnesia";
    version = "4443d810dddc94f5c842f43f79ed5d1785aed837";
    src = fetchFromGitHub ({
      owner = "karlicoss";
      repo = "promnesia";
      rev = "4443d810dddc94f5c842f43f79ed5d1785aed837";
      fetchSubmodules = false;
      sha256 = "sha256-w3zcTmqkwTCVCjTXZ1D9myrOIbxtVnTwpMH6HUYFvZE=";
    });
  };
  spaceship-prompt = {
    pname = "spaceship-prompt";
    version = "3fc9fdc08207feab7020b097789573933c94c677";
    src = fetchFromGitHub ({
      owner = "spaceship-prompt";
      repo = "spaceship-prompt";
      rev = "3fc9fdc08207feab7020b097789573933c94c677";
      fetchSubmodules = false;
      sha256 = "sha256-c8ZYAJE7jZ8bzYYCCNu/f/xazN8+7RVzOI6KWxJmBFg=";
    });
  };
}
