...
{ fetchgit, fetchurl }:
{
  ...
  StevenBlack-hosts = {
    ...
    version = "56f1d1dc3d0c1f476b30c8ebd14a4d476556712e";
    src = fetchgit {
      url = "https://github.com/StevenBlack/hosts";
      rev = "56f1d1dc3d0c1f476b30c8ebd14a4d476556712e";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "1xk6k00zn27mkg3szwpnrh3wd84fsl16p2xhi8rg5j4yhrir9iq0";
    };
  };
  adguardhome = {
    pname = "adguardhome";
  ...
  logseq = {
    ...
    version = "0.4.2";
    src = fetchurl {
      url = "https://github.com/logseq/logseq/releases/download/0.4.2/logseq-linux-x64-0.4.2.AppImage";
  ...
  logseq-darwin = {
    ...
    version = "0.4.2";
    src = fetchurl {
      url = "https://github.com/logseq/logseq/releases/download/0.4.2/logseq-darwin-x64-0.4.2.dmg";
      sha256 = "1pjwp4qa3wd1ywl6w1n2b59z01m2c0y1ybpp3d96y1y479i8vgz8";
    };
  };
  magnetw = {
    pname = "magnetw";
