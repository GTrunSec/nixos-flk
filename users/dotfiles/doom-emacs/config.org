...
(use-package! grammatical-edit
  :config
  (add-hook 'tree-sitter-mode-hook '(lambda ()
...
(when IS-LINUX
  (use-package! emacs-tree-sitter
    :load-path "~/ghq/github.com/GTrunSec/emacs-tree-sitter/lisp"
    :hook ((rustic-mode haskell-mode julia-mode nix-mode emacs-lisp-mode sh-mode python-mode hcl-mode)  . tree-sitter-mode)
    :init
...
#+results:
| tree-sitter-mode | overseer-enable-mode | (lambda nil (setq grammatical-edit-mode 1)) | format-all-mode | ert--activate-font-lock-keywords | outline-minor-mode | rainbow-delimiters-mode | highlight-quoted-mode | +emacs-lisp-extend-imenu-h | +emacs-lisp-init-straight-maybe-h | doom--setq-lisp-indent-function-for-emacs-lisp-mode-h | doom--setq-outline-regexp-for-emacs-lisp-mode-h | doom--setq-mode-name-for-emacs-lisp-mode-h | doom--setq-tab-width-for-emacs-lisp-mode-h | +lookup--init-emacs-lisp-mode-handlers-h | doom--enable-+emacs-lisp-ert-mode-in-emacs-lisp-mode-h | (closure ((hook . emacs-lisp-mode-hook) (--dolist-tail--) t) (&rest _) (add-hook 'flycheck-mode-hook #'flycheck-cask-setup nil t)) |
...
(after! julia
  (set-popup-rule! "^\\*julia"
    :side 'bottom :size 0.4 :quit nil :select nil :ttl 0)
)
