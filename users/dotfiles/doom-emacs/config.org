...
(use-package! helm-tramp
  ...
  (setq helm-tramp-custom-connections '(/sshx:gtrun@10.220.170.112:/home/gtrun
                                        /sshx:gtrun@10.220.170.112:/home/gtrun/.config/guangtao
                                        /sshx:root192.168.122.236:~/
...
(use-package! grammatical-edit
  ...
  :bind (:map grammatical-edit-mode-map
         ...
         ("M-l" . grammatical-edit-jump-right)
         ("M-j" . grammatical-edit-jump-left)
...
#+begin_src emacs-lisp :tangle "nickel-mode.el"
;;; nickel-mode.el -*- lexical-binding: t; -*-
(defvar nickel-mode-font-lock-keywords)
(setq nickel-mode-font-lock-keywords
      `(
        ("\\(//\\)\\(.*\\)$"
         (1 font-lock-comment-delimiter-face t)
         (2 font-lock-comment-face t))
        ("\\([\\{\\}\(\)]\\)"  (1 font-lock-keyword-face))
        ("\\(let\\|if\\|then\\|else\\|fun\\)"  (1 font-lock-keyword-face))
        ("\\([A-Za-z0-1\\ ]+= \\)"   (1 font-lock-variable-name-face))
        ("\\([A-Za-z0-1\\ ]+| \\)"   (1 font-lock-variable-name-face))
        ("\\([A-Za-z0-1\\ ]+=> \\)"  (1 font-lock-constant-face))))

;;;###autoload
(define-derived-mode nickel-mode prog-mode "Nickel Lang"
  "Major mode for nickel."
  (set (make-local-variable 'font-lock-defaults) '(nickel-mode-font-lock-keywords))
  (setq mode-name "nickel"
        indent-line-function 'rustic-indent-line))
...
(when IS-LINUX
  (use-package! emacs-tree-sitter
    ...
    :hook ((rustic-mode haskell-mode julia-mode)  . tree-sitter-mode)
    :init
