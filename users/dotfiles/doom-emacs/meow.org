...
(meow-leader-define-key
 ...
 '("os" . org-roam-buffer)
 '("od" . org-roam-buffer-display-dedicated)
 '("of" . org-roam-buffer-node-find)
...
#+RESULTS:
| fd-dired | consult-recent-file | +vertico/find-file-in | consult-find | consult-ripgrep | meow-M-x | ace-window | org-roam-node-insert | org-roam-buffer | org-roam-buffer-display-dedicated | org-roam-buffer-node-find | org-brain-visualize | org-brain-visualize-dwim | insert-current-date-time-inactive | insert-current-date-time-active | insert-current-date-time | bookmark-set | bookmark-bmenu-list | bm-toggle | switch-to-buffer | +vertico/switch-workspace-buffer | helm-register | point-to-register | bookmark-jump |
...
(map! :map org-mode-map
      ...
      "C-c m"   #'org-roam-complete-link-at-point
      )
#+end_src
